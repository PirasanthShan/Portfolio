...
constructor() {
  ...
  private translations: Record<'EN' | 'DE', TranslationMap> = {
    EN: {
      ...
      aboutMe: 'About Me',
      aboutText: `Since childhood, I have been fascinated by computers and technology. Early on, I wanted to understand how digital systems work and what happens behind the screen. Over time, this curiosity grew into the desire not only to be a user but also to program and develop my own solutions. I do not see challenges as obstacles, but as tasks that can be analyzed and solved step by step. Persistence, analytical thinking, and creativity are among my strengths. Equally important to me is collaboration within a team – achieving success together motivates me more than individual accomplishments.`,
      basedIn: 'Based in Hamm',
    ...
    DE: {
      ...
      aboutMe: 'Über mich',
      aboutText: 'Seit meiner Kindheit begeistern mich Computer und Technik. Schon früh wollte ich verstehen, wie digitale Systeme funktionieren und was sich hinter dem Bildschirm abspielt. Dieses Interesse hat sich mit der Zeit zu dem Wunsch entwickelt, nicht nur Anwender zu sein, sondern selbst zu programmieren und eigene Lösungen zu entwickeln. Herausforderungen sehe ich nicht als Hindernisse, sondern als Aufgaben, die sich Schritt für Schritt analysieren und lösen lassen. Dabei zeichnen mich Ausdauer, analytisches Denken und Kreativität aus. Besonders wichtig ist mir zudem die Zusammenarbeit im Team – Erfolge gemeinsam zu erreichen, motiviert mich mehr als alleinige Resultate.',
      basedIn: 'Ansässig in Hamm',
